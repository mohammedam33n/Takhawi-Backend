...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'slug'                  => ' ',
        'cat_name'              => 'اسم القسم',
        'category_id'           => 'قسم فرعي من',
        'category_type_id'      => 'طبيعة القسم',
        'cat_type'              => 'طبيعة القسم',
        'is_active'             => 'حالة القسم',
        'meta_description'      => 'الـ meta description',
        'thumbnail'             => "الصورة",
        'ad_title'              => "عنوان اﻹعلان",
        'ad_body'               => "الوصف",
        'ads_imgs'              => "صورة اﻹعلان",
        'full_name'             => 'اسمك الكريم',
        'comment'               => 'التعليق',
        'user_id' => "رقم العضوية",
        "fax"=>"فاكس",
        "school"=> "المدرسة",
        "qualification"=> "المؤهل",
        "qualification_year"=> "تاريخ المؤهل",
        "qualification_level"=> "دور المؤهل",
        "degrees"=> "الدرجات",
        "degrees_percent"=> "نسبة الدرجات",
        "set_number"=> "رقم الجلوس",
        "coordination"=> "رقم موافقة مكتب التنسيق",
        "acceptance_type"=> "نوع القبول",
        "moving_from"=> "محول من",
        "moving_year"=>"سنة المؤهل",
        "del_id"=> "رقم id",
