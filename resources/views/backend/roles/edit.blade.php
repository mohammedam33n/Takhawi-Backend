...
@section('title')
    {{__('message.Edit')}} {{__('message.Roles')}}
@endsection
@section('content')
    <!-- Main content -->
            ...
            <form method="POST" action="{{route('roles.update', $role->id)}}" enctype="multipart/form-data">
                ...
                <div class="card-body row">
                    <div class="form-group col-12">
                        ...
                        <input type="text" name="name" value="{{$role->name}}" class="form-control @error('name') is-invalid @enderror" placeholder="{{__('message.Enter')}} {{__('message.Name')}}">
                        @error('name')
